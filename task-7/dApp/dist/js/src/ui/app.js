...
function App() {
    ...
    async function getStoredSaving() {
        const value = await contract.withdrawSavings(account);
    ...
    async function saveMoney() {
        try {
            setTransactionInProgress(true);
            await contract.addSavings(newStoredNumberInputValue, account);
    ...
    return (react_1.default.createElement("div", null,
        ...
        react_1.default.createElement("br", null),
        react_1.default.createElement("br", null),
        react_1.default.createElement("button", { onClick: getStoredSaving, disabled: !contract }, "Get Savings"),
        ...
        react_1.default.createElement("button", { onClick: saveMoney, disabled: !contract }, "Deposit to Savings"),
        react_1.default.createElement("br", null),
        react_1.default.createElement("br", null),
        react_1.default.createElement("br", null),
        react_1.default.createElement("br", null),
