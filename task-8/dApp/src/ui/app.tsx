    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            if (_accounts && _accounts[0]) {
                ...
                const l2Address = await getLayer2Address(_accounts[0], _web3);
        ...
        <div>
           ...
           <h3>Transfer assets from the Ethereum blockchain via Force Bridge</h3>
            ...
            <p>
                ...
                read your savings or deposit more.
            </p>
            ...
            <br />
            <br />
            <button onClick={getStoredSaving} disabled={!contract}>
                Get Savings
            </button>
            ...
            />
            <button onClick={saveMoney} disabled={!contract}>
                Deposit to Savings
            </button>
            <br />
            <br />
